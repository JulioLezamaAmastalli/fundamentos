...
Sin embargo, cuando analizamos los datos de manera gráfica en una gráfica de dispersión encontramos rápidamente que los conjuntos de datos son muy distintos.
...
<!-- ```{r datasaurus_gif, eval=FALSE, echo=FALSE, cache=TRUE} -->
<!-- library(datasauRus) -->
<!-- library(gganimate) -->
<!-- library(animation) -->
...
ggplot(datasaurus_dozen %>% filter(dataset %in% datasets_plot), aes(x = x, y = y)) +
  geom_point() +
  theme(legend.position = "none") +
  facet_wrap( ~ dataset) + ylab("") + xlab("")
```
...
knitr::include_graphics('images/pies.jpg')
```
...
knitr::include_graphics('images/barras_pie.jpg')
```
:::
...
knitr::include_graphics('images/europe_plot.jpg')
```
...
```{r, message=FALSE, warning = FALSE, fig.width = 5, fig.asp=0.7, out.width="55%", fig.align="center"}
